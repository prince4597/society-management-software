...
export const VALIDATION = {
    ...
    PHONE_OPTIONAL: z.string().trim().regex(REGEX.PHONE, 'Format: +CC XXXXXXXXXX (e.g. +91 9876543210)').optional().or(z.literal('')),

    EMAIL: z.string().trim().email('Invalid email address'),
    EMAIL_OPTIONAL: z.string().trim().email('Invalid email address').optional().or(z.literal('')),
