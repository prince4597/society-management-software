...
import { ChevronRight, Layout, Activity, Database, Compass, CheckCircle2, User, Shield, ArrowRight } from 'lucide-react';
...
export const BuildingView = ({ blockName, flats, residents, onFlatClick }: BuildingViewProps) => {
