...
export const SocietyStats = ({ society }: SocietyStatsProps) => {
  const stats = [
    { icon: Users, label: 'Total Asset Load', value: `${society.totalFlats || 0} Units` },
    {
      ...
      value: `${society.admins?.length || 0} Nodes`,
    },
    {
      icon: Calendar,
      label: 'Onboard Date',
      value: society.createdAt
        ...
        >
          <div className="flex items-center gap-3">
            ...
            <div className="flex flex-col min-w-0">
              <p className="text-[10px] font-bold text-muted-foreground uppercase tracking-[0.1em] leading-none mb-1">
                {stat.label}
              </p>
